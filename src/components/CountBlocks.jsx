...
const CountBlocks = () => {
	...
	return (
        ...
        >
            ...
            {/* Inputs */}
            <div className={`flex flex-row justify-center items-center w-[100%] gap-4 p-5 pb-2 pt-2 transition-opacity duration-300 ${showResult ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
